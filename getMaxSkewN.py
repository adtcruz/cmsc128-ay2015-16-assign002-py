...
def getMaxSkewN(str, n): #defines getMaxSkewN function
   ...
   while i <= j: #traverses str until the end position
      ...
      if currSkew > skew: #if current skew is greater than the recorded skew, record the current skew
         skew = currSkew #set the skew from the current skew
   return skew #returns the skew

print getMaxSkewN(str="GGCCAC",n=1) #test cases from Sir Regi
print getMaxSkewN(str="GGCCAC",n=2) #test cases from Sir Regi
print getMaxSkewN(str="GGCCAC",n=3) #test cases from Sir Regi
print getMaxSkewN(str="GGCCAC",n=4) #test cases from Sir Regi
print getMaxSkewN(str="GGCCAC",n=5) #test cases from Sir Regi
